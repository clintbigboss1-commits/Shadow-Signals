...
const SPORT_SCHEDULE = [
  // ── Horse racing & greyhounds — NOT available on The Odds API (404s) ──────
  // Removed: horse_racing_au, horse_racing_us, horse_racing_greyhounds_au
  // Racing data needs Betfair Exchange API integration (future work)
